...
//10>设置session,必须处于脚本最顶部
  ...
  $image = imagecreatetruecolor(80, 38);    //1>设置验证码图片大小的函数
  ...
  for($i=0;$i<200;$i++){
    ...
    imagesetpixel($image, rand(1,79), rand(1,37), $pointcolor);
  }
  //9>增加干扰元素，设置横线
  for($i=0;$i<4;$i++){
    //设置线的颜色
    ...
    //设置线，两点一线
    imageline($image,rand(1,79), rand(1,37),rand(1,79), rand(1,37),$linecolor);
  }
